  ...
  if (profileType === "developer") {
    return (
      ...
      <h3>I'm a</h3>
        ...
        <p>HTML, CSS, Media Queries, Bootstrap, Materialize, JavaScript, JQuery, AJAX, PHP, APIs, JSON, REST, Node, Express, React, React Native, Vue, Angular, GIT, Github, MySQL, Postgresql, MongoDB, Firebase, MS Access, command line, computer science fundamentals
        </p>
      </section>
    );
      ...
      return (
        <section className={styles.aboutMe}>
          ...
          <p> My primary project is <a href="https://www.gypsyswingrevue.com" target= "blank">Gypsy Swing Revue</a>, a gypsy jazz band in the style of the Hot Club of France.
          </p>
          <p> I compose, arrange and teach music.
          </p>
        </section>
      );
  }
